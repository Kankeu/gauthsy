...
<head>
    ...
    <meta name="keywords" content="ntunsige trip travel journey">
    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,600" rel="stylesheet">
    <link rel="icon" href="{{config('company.logo')}}">
...
<body class="xl:px-48 lg:px-48 py-8 md:px-48 sm:px-24 px-8">
<p align="center">
    <u><strong>Politique de confidentialité.</strong></u>
</p>
<ol type="A">
    <li>
        <p>
